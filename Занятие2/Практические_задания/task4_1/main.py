if __name__ == "__main__":
    ...
    for current_value in list_:  # где будем перебирать?
        ...
        if current_value < min_value:  # записать условие
            print("Найден элемент меньший минимума")
            min_value = current_value  #  если нашли, то что делаем?
